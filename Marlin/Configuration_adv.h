...
//#define SENSORLESS_BACKOFF_MM  { 2, 0, 2 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 5, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 25, 125 }, { 210, 125 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  //#define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN               P1_26 // Pin to detect power-loss. Set to -1 to disable default pin on boards without module, or comment to use board default.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  500  // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
 ...
 */
#define STARTUP_COMMANDS "G91 \n G1 Y1 F3000 \n G1 Y-1 F3000 \n G90" // (G-code) Commands to execute on startup. Separate multiple commands with \n
