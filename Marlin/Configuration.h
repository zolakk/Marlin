...
#define STRING_CONFIG_H_AUTHOR "(@zolakk)" // Original author or contributor.
...
#define Z2_STEP_PIN                      P0_19
#define Z2_DIR_PIN                       P0_20
#define Z2_ENABLE_PIN                    P2_08
...
#define CUSTOM_MACHINE_NAME "Geeetech A20M SKR 1.4 Turbo With TMC2130 Drivers"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "9eb32f0c-62d9-4007-b402-83561eeae64b"
...
#define HOTEND_OFFSET_Z { 0.0, -0.10 }  // (mm) relative Z-offset for each nozzle
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  25.7280
    #define DEFAULT_KI   2.1060
    #define DEFAULT_KD 78.5765
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 205, 423.28, 87.1728 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -57.0, -8.0, -1.83 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define I_SAFETY_STOP250
#define J_SAFETY_STOP250
